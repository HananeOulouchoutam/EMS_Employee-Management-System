    ...
    <>
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden text-white hover:text-white p-1"
          >
            <XIcon size={20} />
          </button>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text=[11px] text-slate-500 truncate">
                {role === "ADMIN" ? "Administrator" : "Empployee"}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 px-3 space-y-0.5 overflow-y-auto">
        {navItems.map((item, index) => {
          // 1. Safety Guard: Skip rendering if item or its icon is undefined/false
          if (!item || !item.icon) return null;

          // 2. Fixed: Exact match checking so sub-routes don't conflict
          const isActive =
          ...
          return (
            ...
            >
              ...
              <item.icon
                ...
                }`} // Fixed: Changed typo "text=slate-300" to "text-slate-300"
              />
